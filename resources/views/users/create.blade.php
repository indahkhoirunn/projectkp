              ...
              <div class="panel-body">
                <form class="form-horizontal " method="get">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="nama_pengguna" placeholder="Nama Lengkap">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="email_pengguna" placeholder="saya@email.com">
                    </div>
                  </div>
                  <div class="form-group">
