@extends('guru/materi/layout/main')
@section('sidebar')
<aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          <li class="sub-menu">
            <a href="guru/materi" class="">
                          <i class="icon_book_alt"></i>
                          <span>Materi</span>
                      </a>
          </li>
          <li class="active">
            <a href="guru/assignment" class="">
                          <i class="icon_clipboard"></i>
                          <span>Tugas</span>
                      </a>
          </li>
          <li class="sub-menu">
            <a href="guru/presensi" class="">
      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
            <a href="/guru/assignment/create" class="btn btn-primary"><i class="icon_plus"></i> Tambah Tugas</a>
          </div>
        </div>
        <br>
        @if (session('status'))
